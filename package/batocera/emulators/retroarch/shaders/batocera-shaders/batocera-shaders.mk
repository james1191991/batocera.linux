...
define BATOCERA_SHADERS_INSTALL_TARGET_CMDS
	...
	# sets
	for set in retro-auto bevel sharp-bilinear-simple scanlines enhanced curvature zfast-auto zfast-crt zfast-lcd flatten-glow mega-bezel mega-bezel-lite mega-bezel-ultralite; do \
